...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  /* localStorage validation by KALG */
  useEffect(() => {
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            ...
                            >
                              <span className="text-sm text-gray-200 hover:text-gray-400 font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Añadir prospecto
                              </span>
                            </Link>
                          </li>
